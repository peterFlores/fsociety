...
ESTUDIANTE_ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
ESTUDIANTE_NAME VARCHAR(50) , 
ESTUDIANTE_CARNET VARCHAR(80)
);


INSERT INTO ESTUDIANTES (ESTUDIANTE_ID,ESTUDIANTE_NAME,ESTUDIANTE_CARNT) VALUES (1,'FER','PANAPAN');
